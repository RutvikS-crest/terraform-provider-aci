...
// 			},
// 			{
// 				Config: CreateAccTenantConfig(rName), //can be removed because import is removed
// 			},
// 		},
// 	})
// }
...
// 			},
// 			{
// 				Config: CreateAccTenantUpdatedAttr(rName, "description", "from terraform testing"),
// 				Check: resource.ComposeTestCheckFunc(
// 					testAccCheckAciTenantExists(resourceName, &tenant_updated),
// 					resource.TestCheckResourceAttr(resourceName, "description", "from terraform testing"),
// 					testAccCheckAciTenantIdEqual(&tenant_default, &tenant_updated),
// 				),
// 			},
// 			{
// 				Config: CreateAccTenantUpdatedAttr(rName, "annotation", "testannotation"),
// 				Check: resource.ComposeTestCheckFunc(
// 					testAccCheckAciTenantExists(resourceName, &tenant_updated),
// 					resource.TestCheckResourceAttr(resourceName, "annotation", "testannotation"),
// 					testAccCheckAciTenantIdEqual(&tenant_default, &tenant_updated),
// 				),
// 			},
// 			{
// 				Config: CreateAccTenantUpdatedAttr(rName, "name_alias", "test_name_alias"),
// 				Check: resource.ComposeTestCheckFunc(
// 					testAccCheckAciTenantExists(resourceName, &tenant_updated),
...
// 			},
// 			{
// 				Config: CreateAccTenantConfigRelation(rName, monPolName1),
// 				Check: resource.ComposeTestCheckFunc(
// 					testAccCheckAciTenantExists(resourceName, &tenant_rel1),
// 					resource.TestCheckResourceAttr(resourceName, "relation_fv_rs_tenant_mon_pol", fmt.Sprintf("uni/tn-%s/monepg-%s", monPolName1, monPolName1)),
// 					testAccCheckAciTenantIdEqual(&tenant_default, &tenant_rel1),
// 				),
// 			},
// 			{
// 				Config: CreateAccTenantConfigRelation(rName, monPolName2),
// 				Check: resource.ComposeTestCheckFunc(
// 					testAccCheckAciTenantExists(resourceName, &tenant_rel2),
// 					resource.TestCheckResourceAttr(resourceName, "relation_fv_rs_tenant_mon_pol", fmt.Sprintf("uni/tn-%s/monepg-%s", monPolName2, monPolName2)),
// 					testAccCheckAciTenantIdEqual(&tenant_default, &tenant_rel2),
// 				),
// 			},
// 			{
// 				Config: CreateAccTenantConfig(rName), // this configuration will remove relation
// 				Check: resource.ComposeTestCheckFunc(
// 					resource.TestCheckResourceAttr(resourceName, "relation_fv_rs_tenant_mon_pol", ""), // checking removal of relation
// 				),
// 			},
// 		},
// 	})
...
func CreateAccTenantConfigRelation(rName, monPolName string) string {
	fmt.Println("=== STEP  Basic: testing tenant creation with initial relational parameters")
	resource := fmt.Sprintf(`
