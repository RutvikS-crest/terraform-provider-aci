	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Config: CreateAccFabricIfPolicyConfigWithOptionalValues(rName), // configuration to update optional filelds
				Check: resource.ComposeTestCheckFunc(
			...
			{
				Config: CreateAccFabricIfPolicyConfigWithRequiredParams(rNameUpdated),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciFabricIfPolicyExists(resourceName, &fabric_if_policy_updated),
...
func CreateAccFabricIfPolicyConfigWithRequiredParams(rName string) string {
