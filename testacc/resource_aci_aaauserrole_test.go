...
func TestAccAciUserSecurityDomainRole_Basic(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: CreateAccUserSecurityDomainRoleConfigWithRequiredParams(rName, rNameUpdated, rName),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciUserSecurityDomainRoleExists(resourceName, &user_security_domain_role_updated),
					resource.TestCheckResourceAttr(resourceName, "user_domain_dn", fmt.Sprintf("uni/userext/user-%s/userdomain-%s", rName, rNameUpdated)),
					resource.TestCheckResourceAttr(resourceName, "name", rName),
			...
			{
				Config: CreateAccUserSecurityDomainRoleConfigWithRequiredParams(rName, rName, rNameUpdated),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciUserSecurityDomainRoleExists(resourceName, &user_security_domain_role_updated),
					resource.TestCheckResourceAttr(resourceName, "user_domain_dn", fmt.Sprintf("uni/userext/user-%s/userdomain-%s", rName, rName)),
