...
func TestAccAciDHCPOptionPolicyDataSource_Basic(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config:      CreateAccDHCPOptionPolicyDSWithInvalidParentDn(fvTenantName, rName),
...
func CreateAccDHCPOptionPolicyDSWithInvalidParentDn(fvTenantName, rName string) string {
	fmt.Println("=== STEP  testing dhcp_option_policy Data Source with Invalid Parent Dn")
	resource := fmt.Sprintf(`
