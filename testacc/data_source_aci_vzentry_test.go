		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					// resource.TestCheckResourceAttrPair(dataSourceName, "d_from_port", resourceName, "d_from_port"),
					// resource.TestCheckResourceAttrPair(dataSourceName, "d_to_port", resourceName, "d_to_port"),
					...
					// resource.TestCheckResourceAttrPair(dataSourceName, "s_from_port", resourceName, "s_from_port"),
					// resource.TestCheckResourceAttrPair(dataSourceName, "s_to_port", resourceName, "s_to_port"),
