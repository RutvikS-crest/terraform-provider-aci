...
func TestAccAciLACPPolicy_Basic(t *testing.T) {
	...
	resourceName := "aci_lacp_policy.testacc"
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "ctrl.0", "susp-individual"),
					resource.TestCheckResourceAttr(resourceName, "ctrl.1", "graceful-conv"),
					resource.TestCheckResourceAttr(resourceName, "ctrl.2", "fast-sel-hot-stdby"),
					resource.TestCheckResourceAttr(resourceName, "max_links", "1"),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "max_links", "2"), resource.TestCheckResourceAttr(resourceName, "max_links", ""),
					resource.TestCheckResourceAttr(resourceName, "min_links", "2"), resource.TestCheckResourceAttr(resourceName, "min_links", ""),
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
...

			{
				...
				Config: CreateAccLACPPolicyUpdatedAttr(rName, "ctrl", StringListtoString([]string{"fast-sel-hot-stdby"})),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciLACPPolicyExists(resourceName, &lacp_policy_updated),
					resource.TestCheckResourceAttr(resourceName, "ctrl.#", "1"),
			...
			},
			{
				...
				Config: CreateAccLACPPolicyUpdatedAttr(rName, "ctrl", StringListtoString([]string{"fast-sel-hot-stdby", "graceful-conv"})),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciLACPPolicyExists(resourceName, &lacp_policy_updated),
			...
			},
			{
				...
				Config: CreateAccLACPPolicyUpdatedAttr(rName, "ctrl", StringListtoString([]string{"graceful-conv"})),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciLACPPolicyExists(resourceName, &lacp_policy_updated),
					resource.TestCheckResourceAttr(resourceName, "ctrl.#", "1"),
			...
			},
			{
				...
				Config: CreateAccLACPPolicyUpdatedAttr(rName, "ctrl", StringListtoString([]string{"fast-sel-hot-stdby", "graceful-conv", "load-defer"})),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciLACPPolicyExists(resourceName, &lacp_policy_updated),
					resource.TestCheckResourceAttr(resourceName, "ctrl.#", "3"),
					resource.TestCheckResourceAttr(resourceName, "ctrl.0", "fast-sel-hot-stdby"),
			...
			},
			{
				...
				Config: CreateAccLACPPolicyUpdatedAttr(rName, "ctrl", StringListtoString([]string{"graceful-conv", "load-defer"})),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciLACPPolicyExists(resourceName, &lacp_policy_updated),
					resource.TestCheckResourceAttr(resourceName, "ctrl.#", "2"),
					resource.TestCheckResourceAttr(resourceName, "ctrl.0", "graceful-conv"),
			...
			},
			{
				...
				Config: CreateAccLACPPolicyUpdatedAttr(rName, "ctrl", StringListtoString([]string{"load-defer"})),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciLACPPolicyExists(resourceName, &lacp_policy_updated),
					resource.TestCheckResourceAttr(resourceName, "ctrl.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "ctrl.0", "load-defer"),
			...
			},
			{
				...
				Config: CreateAccLACPPolicyUpdatedAttr(rName, "ctrl", StringListtoString([]string{"fast-sel-hot-stdby", "graceful-conv", "load-defer", "susp-individual"})),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciLACPPolicyExists(resourceName, &lacp_policy_updated),
			...
			},
			{
				...
				Config: CreateAccLACPPolicyUpdatedAttr(rName, "ctrl", StringListtoString([]string{"graceful-conv", "load-defer", "susp-individual"})),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciLACPPolicyExists(resourceName, &lacp_policy_updated),
					resource.TestCheckResourceAttr(resourceName, "ctrl.#", "3"),
					resource.TestCheckResourceAttr(resourceName, "ctrl.0", "graceful-conv"),
			...
			},
			{
				...
				Config: CreateAccLACPPolicyUpdatedAttr(rName, "ctrl", StringListtoString([]string{"load-defer", "susp-individual"})),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciLACPPolicyExists(resourceName, &lacp_policy_updated),
					resource.TestCheckResourceAttr(resourceName, "ctrl.#", "2"),
					resource.TestCheckResourceAttr(resourceName, "ctrl.0", "load-defer"),
					resource.TestCheckResourceAttr(resourceName, "ctrl.1", "susp-individual"),
				),
			},
			{

				Config: CreateAccLACPPolicyUpdatedAttr(rName, "ctrl", StringListtoString([]string{"susp-individual"})),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciLACPPolicyExists(resourceName, &lacp_policy_updated),
					resource.TestCheckResourceAttr(resourceName, "ctrl.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "ctrl.0", "susp-individual"),
			...
			},
			{
				...
				Config: CreateAccLACPPolicyUpdatedAttr(rName, "ctrl", StringListtoString([]string{"fast-sel-hot-stdby", "graceful-conv", "load-defer", "susp-individual", "symmetric-hash"})),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciLACPPolicyExists(resourceName, &lacp_policy_updated),
					...
					resource.TestCheckResourceAttr(resourceName, "ctrl.2", "load-defer"),
					resource.TestCheckResourceAttr(resourceName, "ctrl.3", "susp-individual"),
					resource.TestCheckResourceAttr(resourceName, "ctrl.4", "symmetric-hash"),
				),
			},
			{

				Config: CreateAccLACPPolicyUpdatedAttr(rName, "ctrl", StringListtoString([]string{"graceful-conv", "load-defer", "susp-individual", "symmetric-hash"})),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciLACPPolicyExists(resourceName, &lacp_policy_updated),
					resource.TestCheckResourceAttr(resourceName, "ctrl.#", "4"),
					resource.TestCheckResourceAttr(resourceName, "ctrl.0", "graceful-conv"),
			...
			},
			{
				...
				Config: CreateAccLACPPolicyUpdatedAttr(rName, "ctrl", StringListtoString([]string{"load-defer", "susp-individual", "symmetric-hash"})),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciLACPPolicyExists(resourceName, &lacp_policy_updated),
					resource.TestCheckResourceAttr(resourceName, "ctrl.#", "3"),
					resource.TestCheckResourceAttr(resourceName, "ctrl.0", "load-defer"),
					resource.TestCheckResourceAttr(resourceName, "ctrl.1", "susp-individual"),
					resource.TestCheckResourceAttr(resourceName, "ctrl.2", "symmetric-hash"),
				),
			},
			{

				Config: CreateAccLACPPolicyUpdatedAttr(rName, "ctrl", StringListtoString([]string{"susp-individual", "symmetric-hash"})),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciLACPPolicyExists(resourceName, &lacp_policy_updated),
					resource.TestCheckResourceAttr(resourceName, "ctrl.#", "2"),
					resource.TestCheckResourceAttr(resourceName, "ctrl.0", "susp-individual"),
					resource.TestCheckResourceAttr(resourceName, "ctrl.1", "symmetric-hash"),
				),
			},
			{

				Config: CreateAccLACPPolicyUpdatedAttr(rName, "ctrl", StringListtoString([]string{"symmetric-hash"})),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciLACPPolicyExists(resourceName, &lacp_policy_updated),
					resource.TestCheckResourceAttr(resourceName, "ctrl.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "ctrl.0", "symmetric-hash"),
				),
			},
			{
				Config: CreateAccLACPPolicyUpdatedAttr(rName, "ctrl", StringListtoString([]string{"susp-individual", "graceful-conv", "fast-sel-hot-stdby"})),
			},
			{
...
func TestAccAciLACPPolicy_Negative(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config:      CreateAccLACPPolicyUpdatedAttr(rName, "ctrl", StringListtoString([]string{randomValue})),
				ExpectError: regexp.MustCompile(`expected(.*)to be one of(.)*, got(.)*`),
			},
			{
				Config:      CreateAccLACPPolicyUpdatedAttr(rName, "ctrl", StringListtoString([]string{"fast-sel-hot-stdby", "fast-sel-hot-stdby"})),
...
func CreateAccLACPPolicyConfigWithRequiredParams(rName string) string {
	fmt.Println("=== STEP  testing lacp_policy creation with required arguements only")
...
func CreateAccLACPPolicyConfigUpdatedName(rName string) string {
	fmt.Println("=== STEP  testing lacp_policy creation with with Invalid Name: ", rName)
	resource := fmt.Sprintf(`
...
func CreateAccLACPPolicyConfigWithOptionalValues(rName string) string {
	...
	resource "aci_lacp_policy" "test" {
		...
		ctrl = ["load-defer"]
		max_links = "2"max_links = ""min_links = "2"min_links = ""mode = "active"
	}
	`, rName)
