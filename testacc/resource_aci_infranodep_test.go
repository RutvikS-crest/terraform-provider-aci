		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "relation_infra_rs_acc_card_p.#", "0"),
					resource.TestCheckResourceAttr(resourceName, "relation_infra_rs_acc_port_p.#", "0"),
...
// func CreateAccLeafProfileUpdatedAttrList(rName,attribute,value string) string {
// 	fmt.Printf("=== STEP  testing leaf_profile attribute: %s=%s \n", attribute, value)
// 	resource := fmt.Sprintf(`
