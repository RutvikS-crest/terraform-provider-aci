		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					// resource.TestCheckResourceAttr(resourceName, "tcp_rules.#", "0"),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					// resource.TestCheckResourceAttr(resourceName, "s_to_port", "ftpData"),
					resource.TestCheckResourceAttr(resourceName, "stateful", "yes"),
					// resource.TestCheckResourceAttr(resourceName, "tcp_rules.#", "1"),
					// resource.TestCheckTypeSetElemAttr(resourceName, "tcp_rules.*", "ack"),
...
func TestAccAciFilterEntry_Update(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: CreateAccFilterEntryUpdatedAttr(rName, "d_from_port", "smtp"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciFilterEntryExists(resourceName, &filter_entry_updated),
			...
			{
				Config: CreateAccFilterEntryUpdatedAttr(rName, "d_to_port", "smtp"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciFilterEntryExists(resourceName, &filter_entry_updated),
			...
			{
				Config: CreateAccFilterEntryUpdatedAttr(rName, "d_from_port", "dns"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciFilterEntryExists(resourceName, &filter_entry_updated),
			...
			{
				Config: CreateAccFilterEntryUpdatedAttr(rName, "d_to_port", "dns"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciFilterEntryExists(resourceName, &filter_entry_updated),
			...
			{
				Config: CreateAccFilterEntryUpdatedAttr(rName, "d_from_port", "http"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciFilterEntryExists(resourceName, &filter_entry_updated),
			...
			{
				Config: CreateAccFilterEntryUpdatedAttr(rName, "d_to_port", "http"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciFilterEntryExists(resourceName, &filter_entry_updated),
			...
			{
				Config: CreateAccFilterEntryUpdatedAttr(rName, "d_from_port", "pop3"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciFilterEntryExists(resourceName, &filter_entry_updated),
			...
			{
				Config: CreateAccFilterEntryUpdatedAttr(rName, "d_to_port", "pop3"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciFilterEntryExists(resourceName, &filter_entry_updated),
			...
			{
				Config: CreateAccFilterEntryUpdatedAttr(rName, "d_from_port", "https"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciFilterEntryExists(resourceName, &filter_entry_updated),
			...
			{
				Config: CreateAccFilterEntryUpdatedAttr(rName, "d_to_port", "https"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciFilterEntryExists(resourceName, &filter_entry_updated),
			...
			{
				Config: CreateAccFilterEntryUpdatedAttr(rName, "d_from_port", "rtsp"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciFilterEntryExists(resourceName, &filter_entry_updated),
			...
			{
				Config: CreateAccFilterEntryUpdatedAttr(rName, "d_to_port", "rtsp"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciFilterEntryExists(resourceName, &filter_entry_updated),
			...
			{
				Config: CreateAccFilterEntryUpdatedAttr(rName, "match_dscp", "AF41"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciFilterEntryExists(resourceName, &filter_entry_updated),
					resource.TestCheckResourceAttr(resourceName, "match_dscp", "AF41"),
					testAccCheckAciFilterEntryIdEqual(&filter_entry_default, &filter_entry_updated),
				),
			},
			{
			...
			{
				Config: CreateAccFilterEntryUpdatedAttr(rName, "match_dscp", "CS5"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciFilterEntryExists(resourceName, &filter_entry_updated),
					resource.TestCheckResourceAttr(resourceName, "match_dscp", "CS5"),
					testAccCheckAciFilterEntryIdEqual(&filter_entry_default, &filter_entry_updated),
				),
			},
			{
			...
			{
				Config: CreateAccFilterEntryUpdatedAttr(rName, "match_dscp", "CS6"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciFilterEntryExists(resourceName, &filter_entry_updated),
					resource.TestCheckResourceAttr(resourceName, "match_dscp", "CS6"),
					testAccCheckAciFilterEntryIdEqual(&filter_entry_default, &filter_entry_updated),
				),
			},
			{
				Config: CreateAccFilterEntryUpdatedAttr(rName, "match_dscp", "CS7"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciFilterEntryExists(resourceName, &filter_entry_updated),
					resource.TestCheckResourceAttr(resourceName, "match_dscp", "CS7"),
					testAccCheckAciFilterEntryIdEqual(&filter_entry_default, &filter_entry_updated),
				),
			},
			{
				Config: CreateAccFilterEntryUpdatedAttr(rName, "s_from_port", "smtp"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciFilterEntryExists(resourceName, &filter_entry_updated),
			...
			{
				Config: CreateAccFilterEntryUpdatedAttr(rName, "s_to_port", "smtp"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciFilterEntryExists(resourceName, &filter_entry_updated),
					resource.TestCheckResourceAttr(resourceName, "s_to_port", "smtp"),
					testAccCheckAciFilterEntryIdEqual(&filter_entry_default, &filter_entry_updated),
				),
			},
			{
				Config: CreateAccFilterEntryUpdatedAttr(rName, "s_from_port", "dns"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciFilterEntryExists(resourceName, &filter_entry_updated),
			...
			{
				Config: CreateAccFilterEntryUpdatedAttr(rName, "s_to_port", "dns"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciFilterEntryExists(resourceName, &filter_entry_updated),
					resource.TestCheckResourceAttr(resourceName, "s_to_port", "dns"),
					testAccCheckAciFilterEntryIdEqual(&filter_entry_default, &filter_entry_updated),
				),
			},
			{
				Config: CreateAccFilterEntryUpdatedAttr(rName, "s_from_port", "http"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciFilterEntryExists(resourceName, &filter_entry_updated),
			...
			{
				Config: CreateAccFilterEntryUpdatedAttr(rName, "s_to_port", "http"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciFilterEntryExists(resourceName, &filter_entry_updated),
					resource.TestCheckResourceAttr(resourceName, "s_to_port", "http"),
					testAccCheckAciFilterEntryIdEqual(&filter_entry_default, &filter_entry_updated),
				),
			},
			{
				Config: CreateAccFilterEntryUpdatedAttr(rName, "s_from_port", "pop3"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciFilterEntryExists(resourceName, &filter_entry_updated),
			...
			{
				Config: CreateAccFilterEntryUpdatedAttr(rName, "s_to_port", "pop3"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciFilterEntryExists(resourceName, &filter_entry_updated),
					resource.TestCheckResourceAttr(resourceName, "s_to_port", "pop3"),
					testAccCheckAciFilterEntryIdEqual(&filter_entry_default, &filter_entry_updated),
				),
			},
			{
				Config: CreateAccFilterEntryUpdatedAttr(rName, "s_from_port", "https"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciFilterEntryExists(resourceName, &filter_entry_updated),
			...
			{
				Config: CreateAccFilterEntryUpdatedAttr(rName, "s_to_port", "https"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciFilterEntryExists(resourceName, &filter_entry_updated),
			...
			{
				Config: CreateAccFilterEntryUpdatedAttr(rName, "s_from_port", "rtsp"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciFilterEntryExists(resourceName, &filter_entry_updated),
			...
			{
				Config: CreateAccFilterEntryUpdatedAttr(rName, "s_to_port", "rtsp"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciFilterEntryExists(resourceName, &filter_entry_updated),
					resource.TestCheckResourceAttr(resourceName, "s_to_port", "rtsp"),
					testAccCheckAciFilterEntryIdEqual(&filter_entry_default, &filter_entry_updated),
				),
			},
			{
				Config: CreateAccFilterEntryUpdatedAttr(rName, "tcp_rules", StringListtoString([]string{"est", "ack"})),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciFilterEntryExists(resourceName, &filter_entry_updated),
					resource.TestCheckResourceAttr(resourceName, "tcp_rules.#", "2"),
					resource.TestCheckTypeSetElemAttr(resourceName, "tcp_rules.*", "ack"),
					resource.TestCheckTypeSetElemAttr(resourceName, "tcp_rules.*", "est"),
					testAccCheckAciFilterEntryIdEqual(&filter_entry_default, &filter_entry_updated),
				),
			},
			{
				Config: CreateAccFilterEntryUpdatedAttr(rName, "tcp_rules", StringListtoString([]string{"syn"})),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciFilterEntryExists(resourceName, &filter_entry_updated),
					resource.TestCheckResourceAttr(resourceName, "tcp_rules.#", "1"),
					resource.TestCheckTypeSetElemAttr(resourceName, "tcp_rules.*", "syn"),
					testAccCheckAciFilterEntryIdEqual(&filter_entry_default, &filter_entry_updated),
				),
			},
			{
				Config: CreateAccFilterEntryUpdatedAttr(rName, "tcp_rules", StringListtoString([]string{"fin"})),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciFilterEntryExists(resourceName, &filter_entry_updated),
					resource.TestCheckResourceAttr(resourceName, "tcp_rules.#", "1"),
					resource.TestCheckTypeSetElemAttr(resourceName, "tcp_rules.*", "fin"),
					testAccCheckAciFilterEntryIdEqual(&filter_entry_default, &filter_entry_updated),
				),
			},
			{
				Config: CreateAccFilterEntryUpdatedAttr(rName, "tcp_rules", StringListtoString([]string{"rst"})),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciFilterEntryExists(resourceName, &filter_entry_updated),
					resource.TestCheckResourceAttr(resourceName, "tcp_rules.#", "1"),
					resource.TestCheckTypeSetElemAttr(resourceName, "tcp_rules.*", "rst"),
					testAccCheckAciFilterEntryIdEqual(&filter_entry_default, &filter_entry_updated),
				),
			},
			{
			...
			{
				Config: CreateAccFilterEntryUpdatedAttr(rName, "icmpv4_t", "echo-rep"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciFilterEntryExists(resourceName, &filter_entry_updated),
					resource.TestCheckResourceAttr(resourceName, "icmpv4_t", "echo-rep"),
					testAccCheckAciFilterEntryIdEqual(&filter_entry_default, &filter_entry_updated),
			...
			{
				Config: CreateAccFilterEntryUpdatedAttr(rName, "icmpv6_t", "dst-unreach"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciFilterEntryExists(resourceName, &filter_entry_updated),
					resource.TestCheckResourceAttr(resourceName, "icmpv6_t", "dst-unreach"),
					testAccCheckAciFilterEntryIdEqual(&filter_entry_default, &filter_entry_updated),
			...
			{
				Config: CreateAccFilterEntryUpdatedAttr(rName, "icmpv6_t", "echo-rep"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciFilterEntryExists(resourceName, &filter_entry_updated),
					resource.TestCheckResourceAttr(resourceName, "icmpv6_t", "echo-rep"),
					testAccCheckAciFilterEntryIdEqual(&filter_entry_default, &filter_entry_updated),
				),
			},
			{
			...
			{
				Config: CreateAccFilterEntryUpdatedAttr(rName, "icmpv6_t", "nbr-advent"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciFilterEntryExists(resourceName, &filter_entry_updated),
					resource.TestCheckResourceAttr(resourceName, "icmpv6_t", "nbr-advent"),
					testAccCheckAciFilterEntryIdEqual(&filter_entry_default, &filter_entry_updated),
				),
			},
			{
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				ExpectError: regexp.MustCompile(`Invalid request. dn (.)+ is not valid for class vzEntry`),
			},
			{
...
// func TestAccFilterEntries_MultipleCreateDelete(t *testing.T) {
// 	rName := makeTestVariable(acctest.RandString(5))
...
func CreateAccFilterEntriesConfig(rName string) string {
	...
	resource "aci_filter_entry" "test1"{
		filter_dn = aci_filter.test.id
		name = "%s"
	}

	resource "aci_filter_entry" "test2"{
		filter_dn = aci_filter.test.id
		name = "%s"
	}

	resource "aci_filter_entry" "test3"{
		filter_dn = aci_filter.test.id
		name = "%s"
	}
