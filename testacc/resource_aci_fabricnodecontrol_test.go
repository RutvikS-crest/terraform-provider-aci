		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "control.0", "None"),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "control.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "control.0", "Dom"),
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
...

			{
				...
				Config: CreateAccFabricNodeControlUpdatedAttrList(rName, "control", StringListtoString([]string{"Dom"})),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciFabricNodeControlExists(resourceName, &fabric_node_control_updated),
					resource.TestCheckResourceAttr(resourceName, "control.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "control.0", "Dom"),
			...
			},
			{
				...
				Config: CreateAccFabricNodeControlUpdatedAttrList(rName, "control", StringListtoString([]string{"Dom", "None"})),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciFabricNodeControlExists(resourceName, &fabric_node_control_updated),
					resource.TestCheckResourceAttr(resourceName, "control.#", "2"),
					resource.TestCheckResourceAttr(resourceName, "control.0", "Dom"),
					resource.TestCheckResourceAttr(resourceName, "control.1", "None"),
				),
			},
			{
				Config: CreateAccFabricNodeControlUpdatedAttrList(rName, "control", StringListtoString([]string{"None", "Dom"})),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciFabricNodeControlExists(resourceName, &fabric_node_control_updated),
					resource.TestCheckResourceAttr(resourceName, "control.#", "2"),
					resource.TestCheckResourceAttr(resourceName, "control.0", "None"),
					resource.TestCheckResourceAttr(resourceName, "control.1", "Dom"),
				),
			},
			{
				Config: CreateAccFabricNodeControlConfig(rName),
...
func TestAccAciFabricNodeControl_Negative(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config:      CreateAccFabricNodeControlUpdatedAttrList(rName, "control", StringListtoString([]string{randomValue})),
				ExpectError: regexp.MustCompile(`expected (.)+ to be one of (.)+, got(.)+`),
			},
			{
				Config:      CreateAccFabricNodeControlUpdatedAttrList(rName, "control", StringListtoString([]string{"Dom", "Dom"})),
				ExpectError: regexp.MustCompile(`duplication is not supported in list`),
			},
			// TODO: add unspecified case for "control" if applicable
...
func CreateAccFabricNodeControlConfigWithRequiredParams(rName string) string {
	fmt.Println("=== STEP  testing fabric_node_control creation with updated naming arguments")
...
func CreateAccFabricNodeControlUpdatedAttrList(rName, attribute, value string) string {
	fmt.Printf("=== STEP  testing fabric_node_control attribute: %s = %s \n", attribute, value)
	resource := fmt.Sprintf(`
