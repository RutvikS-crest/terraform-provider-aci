...
// 		Steps: []resource.TestStep{
// 			{
// 				Config: CreateAccL3outHSRPInterfaceProfileConfig(fvTenantName, l3extOutName, l3extLNodePName, l3extLIfPName, ),
// 				Check: resource.ComposeTestCheckFunc(
// 					testAccCheckAciL3outHSRPInterfaceProfileExists(resourceName, &l3out_hsrp_interface_profile_default),
// 				),
// 			},
...
// 			},
// 			{
// 				Config:      CreateAccL3outHSRPInterfaceProfileWithInValidParentDn(fvTenantName, l3extOutName, l3extLNodePName, l3extLIfPName, ),
// 				ExpectError: regexp.MustCompile(`configured object (.)+ not found (.)+,`),
// 			},
// 			{
// 				Config:      CreateAccL3outHSRPInterfaceProfileUpdatedAttr(fvTenantName, l3extOutName, l3extLNodePName, l3extLIfPName, , "description", acctest.RandString(129)),
// 				ExpectError: regexp.MustCompile(`failed validation for value '(.)+'`),
// 			},
// 			{
// 				Config:      CreateAccL3outHSRPInterfaceProfileUpdatedAttr(fvTenantName, l3extOutName, l3extLNodePName, l3extLIfPName, , "annotation", acctest.RandString(129)),
// 				ExpectError: regexp.MustCompile(`failed validation for value '(.)+'`),
// 			},
// 			{
// 				Config:      CreateAccL3outHSRPInterfaceProfileUpdatedAttr(fvTenantName, l3extOutName, l3extLNodePName, l3extLIfPName, , "name_alias", acctest.RandString(64)),
// 				ExpectError: regexp.MustCompile(`failed validation for value '(.)+'`),
// 			},
// 			{
// 				Config:      CreateAccL3outHSRPInterfaceProfileUpdatedAttr(fvTenantName, l3extOutName, l3extLNodePName, l3extLIfPName, , "version", randomValue),
// 				ExpectError: regexp.MustCompile(`expected(.)+ to be one of (.)+, got(.)+`),
// 			},

// 			{
// 				Config:      CreateAccL3outHSRPInterfaceProfileUpdatedAttr(fvTenantName, l3extOutName, l3extLNodePName, l3extLIfPName, , randomParameter, randomValue),
...
// func CreateAccL3outHSRPInterfaceProfileWithInValidParentDn(fvTenantName, l3extOutName, l3extLNodePName, l3extLIfPName,  string) string {
// 	fmt.Println("=== STEP  Negative Case: testing l3out_hsrp_interface_profile creation with invalid parent Dn")
// 	resource := fmt.Sprintf(`
